                    ...
                    <div class="mt-10 py-16 px-6 border-2 border-gray-50 rounded-4xl">
                        ...
                        <div class="max-w-md mx-auto">
                            ...
                            <div class="mt-4">
                                ...
                                <input name="phone"
                                    class="w-full mb-2 py-3 px-12 text-sm border-2 border-gray-300 rounded-xl focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
